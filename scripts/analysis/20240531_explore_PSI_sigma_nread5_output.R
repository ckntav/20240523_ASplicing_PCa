...
for (condition in condition_list) {
  message("# ", condition)
  condition_dir <- paste(sep = "_", "ASplicing_nread5_VCap", condition, "vs", "EtOH")
  
  output_filepath <- file.path(output_dir, condition_dir, paste(sep = "_", "VCap", condition, "vs_CTRL_nread5_r5_ir3.sorted.txt"))
